...
#define USART1_RX_TIMEOUT				3//6	//定义接收超时时间,单位：ms，接收64个字节需用时64*10*(1/115200)=5.55556ms，这里故取值6ms
...
extern uint8_t USART1_RX_TIMEOUT_COUNT;
...
bool Get_F_USART1_RX_FINISH(void);
